...
namespace LaLigaFans.Infrastructure.Migrations
{
    ...
    [Migration("20240416162315_AddedMappingTableBetweenOrderAndProduct")]
    partial class AddedMappingTableBetweenOrderAndProduct
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LaLigaFans.Infrastructure.Data.Models.Order", b =>
                {
                    ...
                    b.Property<int>("AddressId")
                        .HasColumnType("int")
                        .HasComment("Order address identifier");
                    ...
                    b.Property<int>("PaymentId")
                        .HasColumnType("int")
                        .HasComment("Order payment identifier");
            ...
            modelBuilder.Entity("LaLigaFans.Infrastructure.Data.Models.Order", b =>
                {
                    b.HasOne("LaLigaFans.Infrastructure.Data.Models.Address", "Address")
                        .WithOne("Order")
                        .HasForeignKey("LaLigaFans.Infrastructure.Data.Models.Order", "AddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("LaLigaFans.Infrastructure.Data.Models.Payment", "Payment")
                        .WithOne("Order")
                        .HasForeignKey("LaLigaFans.Infrastructure.Data.Models.Order", "PaymentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
